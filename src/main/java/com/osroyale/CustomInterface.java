...
//        bank.child(60, interfaceId + 78, 19, 240);
    ...
    private static void equipmentScreen(TextDrawingArea[] tda) {
        ...
        addSprite(15107, 145);
        addHoverButton(15210, 252, 21, 21, "Close", 250, 15211, 3);
        addHoveredButton(15211, 253, 21, 21, 15212);
        addText(15115, "Equipment bonuses", tda, 2, 0xFF981F, true, true);
        addChar(15125, 650);
        addText(15116, "Melee max hit", tda, 1, 0xFF9200, true, true);
        addText(15117, "Ranged max hit", tda, 1, 0xFF9200, true, true);
        addText(15118, "Drop rate", tda, 1, 0xFF9200, true, true);
        ...
        addSprite(15144, 183);
        addText(15145, "1.2 Kg", tda, 0, 0xFF9200, true, true);
        tab.totalChildren(39);
        tab.child(0, 15107, 5, 8);
        tab.child(1, 15210, 479, 15);
        tab.child(2, 15211, 479, 15);
        tab.child(3, 15115, 253, 16);
        tab.child(4, 15125, 189, 176);
        tab.child(5, 15116, 416, 266);
        tab.child(6, 15117, 416, 281);
        tab.child(7, 15118, 416, 296);
        tab.child(8, RSInterface.interfaceCache[1644].children[12], 399, 58);
        tab.child(9, RSInterface.interfaceCache[1644].children[13], 359, 98);
        tab.child(10, RSInterface.interfaceCache[1644].children[14], 399, 98);
        tab.child(11, RSInterface.interfaceCache[1644].children[15], 439, 98);
        tab.child(12, RSInterface.interfaceCache[1644].children[16], 344, 138);
        tab.child(13, RSInterface.interfaceCache[1644].children[17], 399, 138);
        tab.child(14, RSInterface.interfaceCache[1644].children[18], 454, 138);
        tab.child(15, RSInterface.interfaceCache[1644].children[19], 399, 178);
        tab.child(16, RSInterface.interfaceCache[1644].children[20], 399, 218);
        tab.child(17, RSInterface.interfaceCache[1644].children[21], 344, 218);
        tab.child(18, RSInterface.interfaceCache[1644].children[22], 454, 218);
        tab.child(19, RSInterface.interfaceCache[1644].children[23], 345, 97);
        tab.child(20, 15112, 18, 46);
        tab.child(21, 15113, 18, 141);
        tab.child(22, 15114, 18, 236);
        tab.child(23, 15130, 18, 61);
        tab.child(24, 15131, 18, 76);
        tab.child(25, 15132, 18, 91);
        tab.child(26, 15133, 18, 106);
        tab.child(27, 15134, 18, 121);
        tab.child(28, 15135, 18, 156);
        tab.child(29, 15136, 18, 171);
        tab.child(30, 15137, 18, 186);
        tab.child(31, 15138, 18, 201);
        tab.child(32, 15139, 18, 216);
        tab.child(33, 15140, 18, 251);
        tab.child(34, 15141, 18, 266);
        tab.child(35, 15142, 18, 281);
        tab.child(36, 15143, 18, 296);
        tab.child(37, 15144, 212, 296);
        tab.child(38, 15145, 253, 297);
    }
    ...
    private static void informationTab(TextDrawingArea tda[]) {
        ...
        addHoverButton(29420, 292, 18, 18, "View Achievements Tab", -1, 29421, 1);
        addHoveredButton(29421, 293, 18, 18, 29422);
        ...
        rsinterface.child(6, 29420, 125, 11);
        rsinterface.child(7, 29421, 125, 11);

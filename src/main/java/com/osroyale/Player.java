...
public final class Player extends Entity {
    ...
    public Model getRotatedModel() {
        ...
        if (super.graphic != -1 && super.currentAnimation != -1) {
             ...
             */
            if (Frame.animationlist[spotAnim.animationSequence.primary[0] >> 16].length == 0) {
            ...
            if (spotAnimationModel != null) {
                ...
                model_3.skin();
                model_3.method470(spotAnim.animationSequence.primary[super.currentAnimation]);
    ...
    void updateAppearance(Buffer stream) {
        ...
        super.idleAnimation = stream.readUnsignedShort();

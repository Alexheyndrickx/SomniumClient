...
public class ClientFrame extends Client {
    ...
    private static final int TEXT_COLOR = 0x717171;

    /** Stores the names of the button labels */
    private String[] leftLabels = {"Website", "Forums", "Discord"};
    ...
    public static void load() {
        ...
        try {
            ICON = ImageIO.read(Objects.requireNonNull(ClientFrame.class.getResource("/images/icon2.png")));
            LOGO = ImageIO.read(Objects.requireNonNull(ClientFrame.class.getResource("/images/logo2.png")));
            BG = ImageIO.read(Objects.requireNonNull(ClientFrame.class.getResource("/images/bg.png")));
            BUTTON_IMAGE = ImageIO.read(Objects.requireNonNull(ClientFrame.class.getResource("/images/button.png")));
            BUTTON_HOVER_IMAGE = ImageIO.read(Objects.requireNonNull(ClientFrame.class.getResource("/images/hover.png")));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    private void initializeMenuBar() {
        ...
        menuPanel = new JPanel() {
            ...
            public void paintComponent(Graphics g) {
                ...
                g.drawImage(scaledLogo, this.getWidth() / 2 - 105, 4, null);
